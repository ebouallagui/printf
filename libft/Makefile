...
SRCS = ft_atoi.c ft_itoa.c ft_lstnew.c ft_putendl_fd.c \
	   ...
	   ft_calloc.c ft_lstadd_front.c ft_memchr.c ft_putstr_fd.c \
	   ft_strlen.c ft_toupper.c ft_isalnum.c ft_lstclear.c \
	   ft_memcmp.c ft_split.c ft_strmapi.c ft_isalpha.c \
	   ft_lstdelone.c ft_memcpy.c ft_strchr.c ft_strncmp.c \
	   ft_isascii.c ft_lstiter.c ft_memmove.c ft_strdup.c \
	   ft_strnstr.c ft_isdigit.c ft_lstlast.c ft_memset.c \
	   ft_striteri.c ft_strrchr.c ft_isprint.c ft_lstmap.c \
